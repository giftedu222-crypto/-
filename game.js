...
const fishingPlaces = {
  amnam: { id: 'amnam', name: '암남공원 방파제', startMinutes: 720, sky: 0x68abc1, fog: 0x719ba8, fogDensity: 0.0048, water: [0x083b62, 0x062b4d, 0x041b34], shore: 0x293536, edge: 0xe3b83f, sun: 0xffd281, light: 0xffdfad, catchRates: [{ name: '고등어', rate: 17 }, { name: '전갱이', rate: 14 }, { name: '감성돔', rate: 9 }, { name: '삼치', rate: 8 }, { name: '갈치', rate: 7 }, { name: '학꽁치', rate: 7 }, { name: '갑오징어', rate: 5 }], otherRate: 18, trashRate: 15 },
  yeongdo: { id: 'yeongdo', name: '영도 신방파제', startMinutes: 1320, sky: 0x647f94, fog: 0x687f8b, fogDensity: 0.0045, water: [0x072f50, 0x05233c, 0x031729], shore: 0x4c5352, edge: 0xe7d66a, sun: 0xffe0a8, light: 0xd9e7ed, catchRates: [{ name: '전갱이', rate: 16 }, { name: '갈치', rate: 13 }, { name: '붕장어', rate: 11 }, { name: '학꽁치', rate: 8 }, { name: '고등어', rate: 7 }, { name: '감성돔', rate: 6 }], otherRate: 24, trashRate: 15 },
  dadaepo: { id: 'dadaepo', name: '다대포 · 몰운대', startMinutes: 1070, sky: 0x73a1b3, fog: 0x7f9698, fogDensity: 0.0042, water: [0x0a3c5d, 0x072c49, 0x041c31], shore: 0x766a50, edge: 0xc7aa70, sun: 0xffb657, light: 0xffc88b, catchRates: [{ name: '도다리', rate: 14 }, { name: '감성돔', rate: 14 }, { name: '숭어', rate: 10 }, { name: '농어', rate: 9 }, { name: '참돔', rate: 7 }, { name: '벵에돔', rate: 4 }], otherRate: 27, trashRate: 15 }
};
